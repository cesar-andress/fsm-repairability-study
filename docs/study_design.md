...
| Unit | Description |
|------|-------------|
| **Repair case** | One structurally valid, behaviourally incorrect FSM plus metadata and linked oracle suite. Schema: `schemas/repair_case.schema.json`; format: `docs/repair_case_format.md`. |
