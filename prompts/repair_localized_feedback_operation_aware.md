# Controlled repair prompt — condition E (`patch_localized_feedback`, operation-aware variant)
...
Frozen **operation-aware** template for the second pilot campaign under **localized feedback**. Bind placeholders at run time; do not edit wording after freeze.
---
